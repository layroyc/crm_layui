...
//        customer.setCust_name("雪莹");
//        customer.setCust_company("厚溥");
//        customer.setCust_position("java开发");
//        customer.setCust_phone("17878543543");
//        customer.setCust_birth("2020-09-08");
//        customer.setCust_sex(2);
//        customer.setCust_desc("一个聪明,漂亮的,执着的,技术强大的,美少女");
//        customer.setUser_id(38);
//        customer.setCreate_time("2020-09-08");
//        customer.setModify_time("2020-09-08");
        ...
        int i = customerDAO.deleteByCustomerId(19);
